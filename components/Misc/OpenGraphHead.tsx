...
const OpenGraphHead = () => (
  <Head>
    <title>Lazarte Jonathan | Software Engineer</title>
    <meta name="description" content="My personal solace place on web-earth." />
    <meta property="og:title" content="Lazarte Jonathan | Software Engineer" />
    <meta property="og:site_name" content="Jonathan Adrián Lazarte" />
